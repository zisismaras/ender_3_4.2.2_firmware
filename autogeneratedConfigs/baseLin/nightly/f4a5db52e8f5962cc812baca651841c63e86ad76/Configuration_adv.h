...
#define LIN_ADVANCE //ORIGINAL: //#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0 //ORIGINAL:   #define LIN_ADVANCE_K 0.22    // Unit: mm compression per 1mm/s extruder speed
  //#define LA_DEBUG            // If enabled, this will generate debug information output over USB.
  #define EXPERIMENTAL_SCURVE //ORIGINAL:   //#define EXPERIMENTAL_SCURVE // Enable this option to permit S-Curve Acceleration
  #define ALLOW_LOW_EJERK //ORIGINAL:   //#define ALLOW_LOW_EJERK     // Allow a DEFAULT_EJERK value of <10. Recommended for direct drive hotends.
#endif
